   ...
   <div class="row">
     <div class="col-md-6">
       <div class="box_list wow fadeIn">
         ...
         <figure>
           <a href="detail-page.html"><img src="/images/clinic-1.png" class="img-fluid" alt="">
     ...
     <div class="col-md-6">
       <div class="box_list wow fadeIn">
         <a href="#0" class="wish_bt"></a>
         <figure>
           <a href="detail-page.html"><img src="/images/clinic-2.png" class="img-fluid" alt="">
             <div class="preview"><span>Read more</span></div>
           </a>
         </figure>
         <div class="wrapper">
           ...
           <p>Id placerat tacimates definitionem sea, prima quidam vim no. Duo nobis persecuti cuodo....</p>
           <span class="rating"><i class="icon_star voted"></i><i class="icon_star voted"></i><i class="icon_star voted"></i><i class="icon_star"></i><i class="icon_star"></i> <small>(145)</small></span>
           <a href="badges.html" data-toggle="tooltip" data-placement="top" data-original-title="Badge Level" class="badge_list_1"><img src="/images/user/badges/badge_2.svg" width="15" height="15" alt=""></a>
         </div>
         <ul>
